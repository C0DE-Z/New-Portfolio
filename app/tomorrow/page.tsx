...
export default function TomorrowGame() {
    ...
    return (
        ...
        >
            ...
            {/* Header with Stats Bars permanently displayed in top left */}
            ...
            <div className="flex-grow flex items-center justify-center p-4 md:p-6 bg-black border-b border-neutral-700 overflow-y-auto">
                <div className="w-full max-w-xl text-center select-text">
                    ...
                    {gameState === "playing" && activeScenario && (
                        /* Current Active Scenario Question (Centered) */
                    ...
                    {gameState === "consequence" && lastConsequence && (
                        ...
                        <div className="flex flex-col gap-6 text-center items-center">
                            ...
                            <div className="bg-neutral-900 border border-neutral-800 p-4 font-mono text-xs text-neutral-400 mt-2 flex flex-col gap-2 w-full max-w-sm rounded">
                                <div>
                                    CO_HEALTH: {lastConsequence.coHealthImpact >= 0 ? `+${lastConsequence.coHealthImpact}` : lastConsequence.coHealthImpact}
                                </div>
                                <div>
                                    PER_HEALTH: {lastConsequence.perHealthImpact >= 0 ? `+${lastConsequence.perHealthImpact}` : lastConsequence.perHealthImpact}
                                </div>
                                <div>
                                    TRUST: {lastConsequence.trustImpact >= 0 ? `+${lastConsequence.trustImpact}` : lastConsequence.trustImpact}
                                </div>
                    ...
                    {gameState === "won" && (
                        ...
                        <div className="flex flex-col gap-6 items-center">
                            <h2 className="text-white font-bold text-center border-b border-neutral-800 pb-2 text-lg uppercase tracking-wider w-full max-w-md">
                                ALL SYSTEM PATCHES COMPLETED
                            </h2>
                            <p className="text-neutral-300 text-sm md:text-base leading-relaxed max-w-lg mx-auto">
                                You completed the simulation loop. Unfair Games has completed its Pioneers compilation.
                            </p>
                            <div className="border border-white p-4 font-bold text-white text-sm w-full max-w-xs">
                                FINAL INDEX SCORE: {((companyHealth + personalHealth + sadieTrust) / 10).toFixed(1)} / 30.0
                            </div>
                        </div>
                    )}
                </div>
